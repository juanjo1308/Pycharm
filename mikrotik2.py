...
configurar = [
    '/ip address add address=172.26.14.129/25 interface=ether3',
    '/ip address add address=192.168.14.2/25 interface=ether2',
    '/ip dhcp-client add interface=ether3',
    '/ip pool add name=pool_lan_2 ranges=172.26.14.129-172.26.14.254',
    '/ip dhcp-server add address-pool=pool_lan_2 interface=ether3 name=dhcp_lan_2',
    '/ip dhcp-server network add address=172.26.14.128/25 gateway=172.26.14.129',
